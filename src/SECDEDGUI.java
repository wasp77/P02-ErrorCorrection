...
public class SECDEDGUI extends javax.swing.JFrame {
    ...
    public String encode(String data, int r) {
        ...
        char[] chunkEncoding = new char[totalBits + 1];
        int counter = 0;
        int chunk = dataBits;
        int onesCounter;
        int skipCounter;
    ...
    public String decode(String data, int r) {
        ...
        String decodedData = "";
        int totalBits = (int) (Math.pow(2,r));
        char[] bits = new char[totalBits];
        int[] parityIndex = new int[r + 1];
        int errorCounter;
        int errorLocation;
        int counter = 0;
        int parityCounter;
        ...
        while (chunk <= data.length()) {
            ...
            if (errorCounter > 1 && overAll == false) {
            ...
            } else if (errorCounter > 1 && overAll == true) {
    ...
    public void checkErrors(String data, String decodedData, int r) {
        ...
        if (numErrors > 0) {
            System.out.println("Error postition: " + errorPosition);
        }
    }
